...
var Te = (a, e, t) => e in a ? _e(a, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : a[e] = t;
...
const $e = (a) => new Ce(typeof a == "string" ? a : a + "", void 0, Pe), Ie = (a, e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ue, defineProperty: Ne, getOwnPropertyDescriptor: Le, getOwnPropertyNames: Re, getOwnPropertySymbols: Qe, getPrototypeOf: De } = Object, x = globalThis, ce = x.trustedTypes, ze = ce ? ce.emptyScript : "", O = x.reactiveElementPolyfillSupport, T = (a, e) => a, ie = { toAttribute(a, e) {
  switch (e) {
    case Boolean:
      a = a ? ze : null;
      break;
...
let A = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(T("properties"))) {
      const t = this.properties, i = [...Re(t), ...Qe(t)];
...
A.elementStyles = [], A.shadowRootOptions = { mode: "open" }, A[T("elementProperties")] = /* @__PURE__ */ new Map(), A[T("finalized")] = /* @__PURE__ */ new Map(), O == null || O({ ReactiveElement: A }), (x.reactiveElementVersions ?? (x.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const C = globalThis, pe = (a) => a, H = C.trustedTypes, ge = H ? H.createPolicy("lit-html", { createHTML: (a) => a }) : void 0, Ae = "$lit$", y = `lit$${Math.random().toFixed(9).slice(2)}$`, Se = "?" + y, He = `<${Se}>`, $ = document, U = () => $.createComment(""), N = (a) => a === null || typeof a != "object" && typeof a != "function", ne = Array.isArray, Fe = (a) => ne(a) || typeof (a == null ? void 0 : a[Symbol.iterator]) == "function", j = `[ 	
\f\r]`, _ = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, me = /-->/g, fe = />/g, k = RegExp(`>|${j}(?:([^\\s"'>=/]+)(${j}*=${j}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), be = /'/g, ve = /"/g, Me = /^(?:script|style|textarea|title)$/i, Be = (a) => (e, ...t) => ({ _$litType$: a, strings: e, values: t }), h = Be(1), S = Symbol.for("lit-noChange"), p = Symbol.for("lit-nothing"), ye = /* @__PURE__ */ new WeakMap(), w = $.createTreeWalker($, 129);
function Ee(a, e) {
...
const Oe = (a, e) => {
  ...
  for (let l = 0; l < t; l++) {
    const o = a[l];
    let c, d, g = -1, m = 0;
    for (; m < o.length && (n.lastIndex = m, d = n.exec(o), d !== null); ) m = n.lastIndex, n === _ ? d[1] === "!--" ? n = me : d[1] !== void 0 ? n = fe : d[2] !== void 0 ? (Me.test(d[2]) && (s = RegExp("</" + d[2], "g")), n = k) : d[3] !== void 0 && (n = k) : n === k ? d[0] === ">" ? (n = s ?? _, g = -1) : d[1] === void 0 ? g = -2 : (g = n.lastIndex - d[2].length, c = d[1], n = d[3] === void 0 ? k : d[3] === '"' ? ve : be) : n === ve || n === be ? n = k : n === me || n === fe ? n = _ : (n = k, s = void 0);
    const b = n === k && a[l + 1].startsWith("/>") ? " " : "";
    r += n === _ ? o + He : g >= 0 ? (i.push(c), o.slice(0, g) + Ae + o.slice(g) + y + b) : o + y + (g === -2 ? l : b);
  }
  return [Ee(a, r + (a[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class L {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let r = 0, n = 0;
    const l = e.length - 1, o = this.parts, [c, d] = Oe(e, t);
    ...
    for (; (s = w.nextNode()) !== null && o.length < l; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const g of s.getAttributeNames()) if (g.endsWith(Ae)) {
          const m = d[n++], b = s.getAttribute(g).split(y), v = /([.?@])?(.*)/.exec(m);
...
function M(a, e, t = a, i) {
  ...
  return (s == null ? void 0 : s.constructor) !== r && ((l = s == null ? void 0 : s._$AO) == null || l.call(s, !1), r === void 0 ? s = void 0 : (s = new r(a), s._$AT(a, t, i)), i !== void 0 ? (t._$Co ?? (t._$Co = []))[i] = s : t._$Cl = s), s !== void 0 && (e = M(a, s._$AS(a, e.values), s, i)), e;
}
class je {
  constructor(e, t) {
...
class R {
  ...
  _$AI(e, t = this) {
    e = M(this, e, t), N(e) ? e === p || e == null || e === "" ? (this._$AH !== p && this._$AR(), this._$AH = p) : e !== this._$AH && e !== S && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Fe(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== p && N(this._$AH) ? this._$AA.nextSibling.data = e : this.T($.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var r;
...
class F {
  ...
  _$AI(e, t = this, i, s) {
    ...
    let n = !1;
    if (r === void 0) e = M(this, e, t, 0), n = !N(e) || e !== this._$AH && e !== S, n && (this._$AH = e);
    else {
      const l = e;
      let o, c;
      for (e = r[0], o = 0; o < r.length - 1; o++) c = M(this, l[i + o], t, o), c === S && (c = this._$AH[o]), n || (n = !N(c) || c !== this._$AH[o]), c === p ? e = p : e !== p && (e += (c ?? "") + r[o + 1]), this._$AH[o] = c;
    }
    n && !s && this.j(e);
  }
  j(e) {
...
G == null || G(L, R), (C.litHtmlVersions ?? (C.litHtmlVersions = [])).push("3.3.3");
const We = (a, e, t) => {
...
var we;
I._$litElement$ = !0, I.finalized = !0, (we = P.litElementHydrateSupport) == null || we.call(P, { LitElement: I });
const V = P.litElementPolyfillSupport;
V == null || V({ LitElement: I });
...
h`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><path d="M18 6 6 18M6 6l12 12"/></svg>`;
const ht = h`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>`, ct = h`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>`, dt = h`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M11 6H3"/><path d="M21 6H15"/><path d="M21 12H11"/><path d="M21 18H3"/><path d="M7 12v6"/><path d="M7 6v2"/></svg>`, pt = h`<svg class="icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="9" cy="6" r="1.25"/><circle cx="15" cy="6" r="1.25"/><circle cx="9" cy="12" r="1.25"/><circle cx="15" cy="12" r="1.25"/><circle cx="9" cy="18" r="1.25"/><circle cx="15" cy="18" r="1.25"/></svg>`, J = "om:favorites:v1";
class gt {
  constructor() {
...
const Q = "om-audio-engine", ft = "om-persistent-root", X = "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YQAAAAA=";
class bt {
  constructor() {
    u(this, "audio", null);
    u(this, "track", null);
    ...
    const o = () => {
      ...
      const B = () => {
        ...
        oe || (oe = !0, i ? this.safePlay(n).then(() => {
          var E;
          n.paused && ((E = this.onTick) == null || E.call(this, this.getPositionMs()));
        }).catch(() => {
          var E;
          (E = this.onLoadErrorFn) == null || E.call(this, "Не удалось воспроизвести файл");
  ...
  acquireAudioElement() {
    ...
    const t = document.getElementById(ft) ?? document.getElementById("om-persistent-player") ?? document.documentElement, i = document.createElement("audio");
    return i.id = Q, i.preload = "auto", i.setAttribute("playsinline", ""), i.hidden = !0, t.appendChild(i), this.bindAudioElement(i);
  }
  wireAudioElement(e) {
  ...
  hasActivePlayback() {
    const e = this.audio ?? document.getElementById(Q);
...
class yt {
  constructor() {
    ...
    e || (e = crypto.randomUUID(), sessionStorage.setItem("om:tab-id", e)), this.tabId = e, "BroadcastChannel" in window && (this.channel = new BroadcastChannel(vt), this.channel.onmessage = (t) => {
      const i = t.data;
...
let ee = null;
function xt() {
  return ee || (ee = new yt()), ee;
}
const xe = "om:playback:v1", ke = "om:session-id";
class kt {
  constructor() {
    u(this, "engine", new bt());
    u(this, "queue", []);
    u(this, "queueIndex", 0);
    u(this, "volume", 0.85);
    u(this, "repeat", "off");
  ...
  setQueue(e, t = 0, i = 0, s = !0, r = !1) {
    var d;
    const n = (d = this.engine.getCurrentTrack()) == null ? void 0 : d.slug;
...
class se extends I {
  ...
  connectedCallback() {
    ...
    this.store.getCurrentTrack() && (this.visible = !0), this.addEventListener("om:cmd-next", this.onCmdNext), this.addEventListener("om:cmd-prev", this.onCmdPrev), this.mode === "full" ? this.loadPageTracksFromPage() : this.mode === "embed" && this.track && (this.autoPlay ? this.playSlug(this.track) : this.scheduleEmbedPreload()), (this.mode === "mini" || this.mode === "full" || this.mode === "embed") && this.startProgressTimer(), this.heartClickHandler = (t) => {
      ...
      t.key === "Escape" && this.queueExpanded && this.closeQueueExpanded();
  ...
  renderProgress(t, i = !1, s = !1) {
    ...
    return h`
      <div class="progress-wrap${i ? " progress-wrap--compact" : ""}${s ? " progress-wrap--inline" : ""}${this.seeking ? " is-scrubbing" : ""}${o ? " progress-wrap--readonly" : ""}">
        ${s ? p : h`<span class="time">${D(n)}</span>`}
        <div
        ...
        ${s ? p : h`<span class="time">${D(r)}</span>`}
      </div>
    `;
  }
  seekFromPointer(t, i) {
    ...
    return h`
      ...
      return h`
        ...
        o.stopPropagation(), this.addTrackToQueue(i, !0);
                    ...
                    <span class="queue-duration">${D(i.durationMs)}</span>
                  </span>
                </li>
              `;
    })}
  ...
  async addTrackToQueue(t, i) {
    ...
    if (this.client)
      try {
        ...
        (i ? this.store.playNext(l) : this.store.addToQueue(l)) && (this.visible = !0, i ? this.showQueueNotice(o ? "Перемещено вверх" : "Будет следующим") : this.showQueueNotice("Добавлено в очередь"), (n = (r = qt()) == null ? void 0 : r.showPublic) == null || n.call(r));
      } catch {
  ...
  renderQueueList(t = {}) {
    ...
    return h`
      ...
      const d = this.queue[o];
      if (!d) return p;
      const g = o === this.store.queueIndex, m = l && this.queueDragOver === o && this.queueDragFrom !== o, b = r ? o - this.store.queueIndex + 1 : d.trackNumber ?? o + 1;
      return h`
              <li
                role="listitem"
                data-queue-index=${o}
              ...
              >
                ...
                <span class="queue-title-text" @click=${() => this.playQueueIndex(o)}>${d.title}</span>
                <span class="queue-actions">
        ...
        v.stopPropagation(), this.store.removeAt(o);
                        ...
                        >${ht}</button>
                      ` : p}
                  <span class="queue-duration">${D(d.durationMs)}</span>
                </span>
              </li>
            `;
    })}
  ...
  renderQueueSheet() {
    var s, r;
    if (!this.queueExpanded || this.mode !== "mini") return p;
    ...
    return h`
      ...
      >
        ...
        ${this.queueNotice ? h`<div class="queue-toast" role="status">${this.queueNotice}</div>` : p}
  ...
  render() {
    ...
    if (this.mode === "embed") {
      const o = this.embedSource, d = (this.hasLiveAudio() ? (i = this.current) == null ? void 0 : i.durationMs : void 0) ?? (o == null ? void 0 : o.durationMs) ?? 0, g = d > 0 && !!o, m = this.isEmbedPlaying();
      return h`
        <div class="player player--embed" role="group" aria-label="Плеер">
          ...
          <div class="embed-body">
            ...
            ${g ? this.renderProgress(d, !0) : p}
            ${this.error ? h`<p class="error-text">${this.error}</p>` : p}
          </div>
        </div>
      `;
    }
    if (this.mode === "full") {
      ...
      return h`
        <div class="player player--full" role="region" aria-label="Плеер альбома">
          ${this.loading ? h`<div class="state">Загрузка треков…</div>` : p}
          ${this.error ? h`<div class="state state--error">${this.error}</div>` : p}
          <div class="full-layout">
            <aside class="full-now">
              ...
              ${this.current ? this.renderProgress(o) : p}
              ${c && this.album ? h`<button class="btn-start-album" @pointerdown=${() => this.store.engine.unlockUserGesture()} @click=${() => this.loadQueue(!0)}>Слушать альбом</button>` : p}
            </aside>
    ...
    return this.queueExpanded ? h`${this.renderQueueSheet()}` : h`
      <div class="player player--mini" role="region" aria-label="Мини-плеер">
        <div class="mini-row">
          ...
          ${this.current ? this.renderProgress(t, !0, !0) : p}
  ...
  async restoreQueuePublic(t, i, s, r, n, l = !0) {
    if (this.client) {
      ...
      try {
        const { data: o } = await this.client.getAlbumTracks(t), c = new Map(o.map((m) => [m.slug, m]));
        let d = s.map((m) => c.get(m)).filter((m) => !!m);
        d.length === 0 && (d = o);
        const g = Math.max(0, Math.min(r, d.length - 1));
        this.store.restoreQueue(o, d, g, n, l), await this.store.waitUntilReady();
      } catch {
...
u(se, "styles", $e(Pt)), u(se, "properties", {
